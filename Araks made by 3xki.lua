-- Arxki Made by dog 3xki
local Ui Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/tuktuk322/Arkxi/refs/heads/main/Ui.txt"))()
local AimlockModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/tuktuk322/Arkxi/refs/heads/main/AimLockModule.txt"))()
local ESPModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/tuktuk322/Arkxi/refs/heads/main/EspModule.txt"))()
local SilentAimModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/tuktuk322/Arkxi/refs/heads/main/SilentAimModule.txt"))()
local StuffsModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/tuktuk322/Arkxi/refs/heads/main/StuffsModule.txt"))()
local OthersStuffsModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/tuktuk322/Arkxi/refs/heads/main/OtherStuffsModule.txt"))()
local UiSettingsModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/tuktuk322/Arkxi/refs/heads/main/UiSettingsModule.txt"))()
local ZSkillModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/tuktuk322/Arkxi/refs/heads/main/ZSKillModule.txt"))()
...
local Window = Library.CreateLib("Arxki Hub  |  " .. executor, UiSettingsModule.currentTheme)
...
Section:NewDropdown("・Prediction Future | Default 0.1s", "Select max Prediction for Silent Aim", {"0.1", "0.2", "0.3", "0.4"}, function(selected)
    local num = tonumber(selected)
    if num then
...
Section:NewDropdown("・Distance Limit | Default 1000m", "Select max distance for aimbot", {"200", "400", "600", "1000"}, function(selected)
    local num = tonumber(selected)
    if num then
...
Section:NewButton("Join Discord", "Get Link Discord server", function()
    local link = "https://discord.gg/MugzjYR9Hk"
...
Section:NewDropdown("・Global Text Font", "Change font for all text", {
    "Arcade", "Cartoon", "SciFi", "Fantasy", "Antique", "Garamond", "RobotoMono",
    "FredokaOne", "LuckiestGuy", "PermanentMarker", "SpecialElite", "Oswald", "Nunito"
}, function(selected)
...
-- dawg this is my script and tell if its good or not